...
s.frameworks = 'Foundation', 'UIKit', 'CoreMedia', 'CoreServices'
...
s.requires_arc = true
s.public_header_files = 'ZZPhotoPickerController/ZZPhotoPickerController/Current/C/ZZPhotoPickerController.swift'
s.swift_version = '4.2'
